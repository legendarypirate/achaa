...
const PackageModal = ({ id, visible, onCancel }) => {
  ...
  useEffect(() => {
    Axios.get("/packages/getStatuses").then((res) => {
  ...
  const renderStatusOptions = () => {
    ...
    if (statuses) {
      options = statuses.map((item, index) => {
        return (
  ...
  return (
    <Modal visible={visible} onCancel={onCancel}>
      <form className="packageModal" onSubmit={saveOnClick}>
        <div className="packageModal__userInfo">
          <p>
        ...
        <div className="packageModal__content">
          <div className="packageModal__content-cell">
            <div className="packageModal__content-cell-infos">
              <p>
            ...
            {data.status_id >= 4 && (
              <div className="packageModal__content-cell-input">
                <label>Aчааны төлөв</label>
                <select
                  name="status_id"
          ...
          <div className="packageModal__content-cell">
            <div className="packageModal__content-cell-input">
              ...
              <div className="packageModal__content-cell-input-body">
                Хаанаас:
                <select
                  name="come_from"
                  about="where"
            ...
            <div className="packageModal__content-cell-input">
              ...
              <a
                className="packageModal__content-cell-input-list"
                href="!#"
                download="list.png"
              >
                Жишээ маягт татах
